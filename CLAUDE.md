...
├── scripts/                # Tooling; .vercelignore'd, not deployed
│   ├── og-card.html        # 1200×630 share-card template
│   ├── generate-og-cards.mjs
│   └── test-motion.mjs     # Reveal/entrance/view-transition checks, both sites
├── robots.txt
└── sitemap.xml
```
